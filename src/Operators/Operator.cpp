...
Operator::Operator() : is_arithmetic(false) {

}

Operator::Operator(size_t id) : is_arithmetic(false) {
...
std::string Operator::GetPythonReadableExpression(const std::vector<std::string> & args){
return std::string();
}
