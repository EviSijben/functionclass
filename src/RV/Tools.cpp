 ...
 */
double **RV::matrixNew( int n, int m )
{
    int      i;
    double **result;
 ...
 */
double RV::vectorDotProduct( double *vector0, double *vector1, int n0 )
{
    int    i;
    double result;
 ...
 */
double RV::vectorNorm( double *vector0, int n0 )
{
 ...
 * dimensionality n1.
 */
double * RV::matrixVectorMultiplication( double **matrix, double *vector, int n0, int n1 )
{
    int     i;
    double *result;
...
double * RV::matrixVectorPartialMultiplication( double **matrix, double *vector, int n0, int n1, int number_of_elements, int *element_indices )
{
    int i,j,index;
    double *result;
 ...
 */
double **RV::matrixMatrixMultiplication( double **matrix0, double **matrix1, int n0, int n1, int n2 )
{
    int     i, j, k;
    double **result;
 ...
 * BLAS subroutine.
 */
int RV::blasDSWAP( int n, double *dx, int incx, double *dy, int incy )
{
    double dtmp;
 ...
 * BLAS subroutine.
 */
int RV::blasDAXPY(int n, double da, double *dx, int incx, double *dy, int incy)
{
 ...
 * BLAS subroutine.
 */
void RV::blasDSCAL( int n, double sa, double x[], int incx )
{
    int i, ix, m;
 ...
 * LINPACK subroutine.
 */
int RV::linpackDCHDC( double a[], int lda, int p, double work[], int ipvt[] )
{
 ...
 */
double **RV::choleskyDecomposition( double **matrix, int n )
{
    int     i, j, k, info, *ipvt;
 ...
 * LINPACK subroutine.
 */
int RV::linpackDTRDI( double t[], int ldt, int n )
{
    int    j, k, info;
    double temp;
 ...
 */
double **RV::matrixLowerTriangularInverse( double **matrix, int n )
{
    int     i, j, k, info;
    double *t, **result;
...
void RV::eigenDecomposition( double **matrix, int n, double **D, double **Q )
{
    int     i, j;
    double *rgtmp, *diag;
...
void RV::eigenDecompositionQLalgo2( int n, double **V, double *d, double *e )
{
    int i, k, l, m;
    double f = 0.0;
    double tst1 = 0.0;
...
double RV::myhypot( double a, double b )
{
    double r = 0;
    if( fabs(a) > fabs(b) )
    {
...
void RV::eigenDecompositionHouseholder2( int n, double **V, double *d, double *e )
{
    int i,j,k;
 ...
 */
void RV::matrixWriteToFile( FILE *file, double **matrix, int n0, int n1 )
{
    int  i, j;
 ...
 */
int *RV::mergeSort( double *array, int array_size )
{
    int i, *sorted, *tosort;
 ...
 */
void RV::mergeSortWithinBounds( double *array, int *sorted, int *tosort, int p, int q )
{
    int r;
...
void RV::mergeSortWithinBoundsInt( int *array, int *sorted, int *tosort, int p, int q )
{
    int r;
 ...
 */
void RV::mergeSortMerge( double *array, int *sorted, int *tosort, int p, int r, int q )
{
    int i, j, k, first;
...
int *RV::mergeSortInt( int *array, int array_size )
{
    int i, *sorted, *tosort;
...
void RV::mergeSortMergeInt( int *array, int *sorted, int *tosort, int p, int r, int q )
{
    int i, j, k, first;
...
int *RV::getRanks( double *array, int array_size )
{
    int i, *sorted, *ranks;
...
int *RV::getRanksFromSorted( int *sorted, int array_size )
{
    int i, *ranks;
...
long RV::getCurrentTimeStampInMilliSeconds()
{
    struct timeval tv;
    //struct tm *timep;
    long   result;
 ...
 */
double RV::randomRealUniform01( void )
{
    int64_t n26, n27;
    double  result;
 ...
 */
double RV::random1DNormalUnit( void )
{
 ...
 */
double RV::random1DNormalParameterized( double mean, double variance )
{
    double result;
 ...
 */
void RV::initializeRandomNumberGenerator( void )
{
    struct timeval tv;
...
//    FILE *file;
//    file = fopen("results/random_seed.dat", "w");
//    fprintf( file, "%ld\n", random_seed );
//    fclose(file);
 ...
 */
int *RV::randomPermutation( int n )
{
 ...
 * radix-sort order.
 */
int **RV::allPermutations( int length, int *numberOfPermutations )
{
    int **result;
 ...
 */
int **RV::allPermutationsSubroutine( int from, int length, int *numberOfPermutations )
{
...
double RV::min( double x, double y )
{
    if( x <= y )
        return x;
    return y;
...
double RV::max( double x, double y )
{
    if( x >= y )
        return x;
    return y;
 ...
 */
double RV::distanceEuclidean( double *x, double *y, int number_of_dimensions )
{
    int    i;
    double value, result;
 ...
 */
double RV::distanceEuclidean2D( double x1, double y1, double x2, double y2 )
{
    double result;
