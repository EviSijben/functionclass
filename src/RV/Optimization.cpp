 ...
 */
void RV::initializeObjectiveRotationMatrix( void )
{
...
void RV::ezilaitiniObjectiveRotationMatrix( void )
{
    int i;
...
double *RV::rotateAllParameters( double *parameters )
{
    return( rotateParametersInRange( parameters, 0, number_of_parameters-1 ) );
}

double *RV::rotateParametersInRange( double *parameters, int from, int to )
{
    int i, j;
