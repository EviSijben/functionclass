 ...
 */
short RV::betterFitness( double objective_value_x, double constraint_value_x, double objective_value_y, double constraint_value_y )
{
    short result;
 ...
 */
char *RV::installedProblemName( int index )
{
    switch( index )
    {
    ...
    case 23: return( (char *) "GPExpression" );
 }
 ...
 */
int RV::numberOfInstalledProblems()
{
    static int result = -1;
 ...
 */
void RV::printAllInstalledProblems()
{
    int i, n;
 ...
 */
double RV::installedProblemLowerRangeBound( int index, int dimension )
{
    switch( index )
    {
    ...
    case 23: return( GPExpressionFunctionLowerRangeBound( dimension ) );
    }
 ...
 */
double RV::installedProblemUpperRangeBound( int index, int dimension )
{
    switch( index )
    {
    ...
    case 23: return( GPExpressionFunctionUpperRangeBound( dimension ) );
    }
 ...
 * every problem.
 */
short RV::isParameterInRangeBounds( double parameter, int dimension )
{
 ...
 */
void RV::initializeParameterRangeBounds()
{
    int i;
 ...
 * been changed.
 */
void RV::installedProblemEvaluation( int index, double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *parameters_before, double objective_value_before, double constraint_value_before )
{
 ...
 * Both are returned using pointer variables.
 */
void RV::installedProblemEvaluationWithoutRotation( int index, double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *touched_parameters, double *parameters_before, double objective_value_before, double constraint_value_before)
{
    *objective_value  = 0.0;
    *constraint_value = 0.0;
    if( black_box_evaluations || touched_parameters_indices == NULL )
    {
        ...
        case 23: GPExpressionFunctionProblemEvaluation(parameters, objective_value, constraint_value ); break;
        }
...
void RV::sphereFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
void RV::sphereFunctionPartialProblemEvaluation( double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *touched_parameters, double *parameters_before, double objective_value_before, double constraint_value_before )
{
    int    i;
    double result;
...
double RV::sphereFunctionProblemLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::sphereFunctionProblemUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::ellipsoidFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
void RV::ellipsoidFunctionPartialProblemEvaluation( double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *touched_parameters, double *parameters_before, double objective_value_before, double constraint_value_before )
{
    int    i;
    double result;
...
double RV::ellipsoidFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::ellipsoidFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::cigarFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
double RV::cigarFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::cigarFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::tabletFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
double RV::tabletFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::tabletFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::cigarTabletFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
double RV::cigarTabletFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::cigarTabletFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::twoAxesFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
double RV::twoAxesFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::twoAxesFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::differentPowersFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
double RV::differentPowersFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::differentPowersFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::rosenbrockFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
void RV::rosenbrockFunctionPartialProblemEvaluation( double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *touched_parameters, double *parameters_before, double objective_value_before, double constraint_value_before )
{
    int    i, j;
    double result;
...
double RV::rosenbrockFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::rosenbrockFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::parabolicRidgeFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double sum, result;
...
double RV::parabolicRidgeFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::parabolicRidgeFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::sharpRidgeFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double sum, result;
...
double RV::sharpRidgeFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::sharpRidgeFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::griewankFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
...
double RV::griewankFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::griewankFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::michalewiczFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
void RV::michalewiczFunctionPartialProblemEvaluation( double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *touched_parameters, double *parameters_before, double objective_value_before, double constraint_value_before )
{
    int    i;
    double result;
...
double RV::michalewiczFunctionLowerRangeBound( int dimension )
{
    return( 0.0 );
}

double RV::michalewiczFunctionUpperRangeBound( int dimension )
{
    return( PI );
}

void RV::rastriginFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i;
    double result;
...
void RV::rastriginFunctionPartialProblemEvaluation( double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *touched_parameters, double *parameters_before, double objective_value_before, double constraint_value_before )
{
    int    i;
    double result;
...
double RV::rastriginFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::rastriginFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::sumOfEllipsoidsFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i, j;
    double result;
...
void RV::sumOfEllipsoidsFunctionPartialProblemEvaluation( double *parameters, double *objective_value, double *constraint_value, int number_of_touched_parameters, int *touched_parameters_indices, double *touched_parameters, double *parameters_before, double objective_value_before, double constraint_value_before )
{
    int    i, j;
    double result;
...
double RV::sumOfEllipsoidsFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::sumOfEllipsoidsFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}

void RV::ciasBRFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i, j, nc;
...
double RV::ciasBRFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::ciasBRFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}
...
void RV::trapSphereFunctionProblemEvaluation( double *parameters, double *objective_value, double *constraint_value )
{
    int    i, j, m, k, u;
    double result;
...
double RV::trapSphereFunctionLowerRangeBound( int dimension )
{
    return( -1e+308 );
}

double RV::trapSphereFunctionUpperRangeBound( int dimension )
{
    return( 1e+308 );
}


void RV::GPExpressionFunctionProblemEvaluation(double *parameters, double *objective_value, double *constraint_value) {
    *objective_value = 0;
    *constraint_value = 0;

    double result = 0;
    for (size_t j =0 ; j < FCs.size(); j++){
        ((OpFunctionClassConst*)FCs[j])->SetConstant(parameters[j]);
    }
    arma::vec output = ((SingleNode*)tree)->GetOutput(x,true).col(0);
    if (output.has_nan()){
        *objective_value = NAN;
    } else {
        result += arma::sum(arma::square((output - y) ));
        *objective_value = result / double(nr_per_set);
    }
    if (calc_constraints){
        arma::vec output = (tree->GetOutput(m , false)).col(0);
        ...
        if (std::isnan(output[0]) || output[0] < 0.0 || output[0] > 0.01 ){
            *constraint_value += 1.0;
        }
    }
...
double RV::GPExpressionFunctionLowerRangeBound( int dimension )
{
    return( -10000);
}

double RV::GPExpressionFunctionUpperRangeBound(int dimension) {
    return(  10000 );
}
/*-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=*/
